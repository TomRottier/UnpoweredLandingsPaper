    ...
    if axes
        ...
        push!(
            ...
            S.Text(
                ...
                text=L"\hat{e}_z", align=(:center, :center), offset=(10, 4), space
            ),
            S.Text(
            ...
            S.Text(
                ...
                text=L"\hat{e}_\gamma", align=(:center, :center), offset=(8, 0), space
            ),
            S.Text(
                Point2(axpt .+ 0.65 * axlen .* [cos(γ / 2), sin(γ / 2)]);
                text=L"\gamma", align=(:center, :center), space, offset=(-5, 15)
            ),
        )
    end
