...
This requirement could have shaped the evolution of avian morphology by setting a minimum requirement on the amount of hind-limb skeletomuscular mass @heersWingsLegsAvian2015 @shinFastGroundtoairTransition2024. Unpowered theories of flight evolution @ostromBirdFlightHow1979 @norbergEvolutionVertebrateFlight1985 assume a limited ability to flap the wings and so the legs would be required to dissipate all the remaining energy, increasing the required amount of hindlimb mass. Reducing the touchdown speed reduces the required hindlimb mass and would lead to improved flight economy @kullbergImpairedPredatorEvasion1997 @mardenMaximumLiftProduction1987.

Extant waterfowl (_Anatidae_), such as ducks, geese, and swans, land differently on water than on solid ground @whiteheadMallardLandingBehavior2023. This may be in part due to the different levels of kinetic energy which can be tolerated at touchdown on these two surfaces. More kinetic energy is dissipated to the water than is possible on solid ground, allowing larger touchdown speeds and different landing behaviours. It is interesting to note some of these species, particularly geese and swans, are some of the heavier species of bird and given in the unfavourable scaling of landing with size (@sec-results-optcontrol), landing on water may be a chosen strategy to reduce touchdown requirements.

#figure(
  image("../figs/constraints.pdf"),
  // box(width: 100%, height: 150pt, fill: luma(240), stroke: 1pt + black),
  caption: [
    Minimum touchdown speed solutions for ground-landings. All trajectories are
    constrained to have $gamma lt.eq 0$ and a
    touchdown angle between 0 and $- pi \/ 2$. Trajectories shown in
    bold for a touchdown angle of 0 (green), $- pi \/ 2$ (red), and the
