...
Extant waterfowl (_Anatidae_), such as ducks, geese, and swans, land differently on water than on solid ground @whiteheadMallardLandingBehavior2023. This may be in part due to the different levels of kinetic energy which can be tolerated at touchdown on these two surfaces. More kinetic energy is dissipated to the water than is possible on solid ground, allowing larger touchdown speeds and different landing behaviours. It is interesting to note some of these species, particularly geese and swans, are some of the heavier species of bird and given the unfavourable scaling of landing with size (@sec-results-optcontrol), landing on water may be a chosen strategy to reduce touchdown requirements.
