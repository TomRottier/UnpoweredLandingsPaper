...
This model is representative of experimental data over a broad range of angles of attack at Reynolds numbers relevant to birds \cite{usherwoodAerodynamicsRevolvingWings2002a,leishmanPrinciplesHelicopterAerodynamics2017,nabawyRoleLeadingEdge2017} and has been used in previous models of cruising flight \cite{parslewSimulatingAvianWingbeat2010} and of free-flight data \cite{mooreRobustPoststallPerching2014}. Some differences in the coefficients are to be expected across species \cite{leesInfluenceFlightStyle2016} and we address this through a sensitivity analysis of the model's parameters in Section~\ref{sec-results-sensitivity}.
